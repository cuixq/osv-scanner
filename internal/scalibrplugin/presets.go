...
import (
	...
	scalibrdepsdev "github.com/google/osv-scalibr/depsdev"
...
func baseImageEnricher(_ *cpb.PluginConfig) (enricher.Enricher, error) {
	...
	insightsClient, err := depsdev.NewInsightsAlphaClient(scalibrdepsdev.DepsdevAPI, "osv-scanner_scan/"+version.OSVVersion)
	if err != nil {
